...
namespace Workflow\Tests\Handler;
...
use Workflow\Tests\Fixtures\FakeProcessListener;
Use Workflow\Tests\Fixtures\FakeModel;
use Workflow\Tests\Fixtures\FakeSecurityContext;
use Workflow\Tests\Fixtures\FakeValidatorListener;
...
class ProcessHandlerTest extends TestCase
{
    ...
    /**
     * @var Workflow\Model\ModelStorage
     */
    ...
    protected function setUp()
    {
        ...
        $this->modelStorage = new ModelStorage($this->em, 'Workflow\Entity\ModelState');
    }
    ...
    /**
     * @expectedException        Workflow\Exception\WorkflowException
    ...
    public function testReachNextStateWithListener()
    {
        ...
        $reflectionClass = new \ReflectionClass('Workflow\Handler\ProcessHandler');
    ...
    protected function getProcessHandler()
    {
        $stepValidateDoc = new Step(
            ...
            'Validate doc',
            array(),
            array('setStatus', 'Workflow\Tests\Fixtures\FakeModel::STATUS_VALIDATE')
        );
        ...
        $stepRemoveDoc = new Step(
            ...
            'Remove doc',
            array(),
            array('setStatus', 'Workflow\Tests\Fixtures\FakeModel::STATUS_REMOVE')
        );
        ...
        $stepCreateDoc = new Step(
            ...
            'Create doc',
            array(),
            array('setStatus', 'Workflow\Tests\Fixtures\FakeModel::STATUS_CREATE')
        );
