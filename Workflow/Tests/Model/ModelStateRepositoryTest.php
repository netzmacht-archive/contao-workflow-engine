...
namespace Workflow\Tests\Model;
...
class ModelStateRepositoryTest extends TestCase
{
    ...
    public function testFindLatestModelState()
    {
        ...
        $repository = $this->em->getRepository('Workflow\Entity\ModelState');

        $this->assertInstanceOf('Workflow\Model\ModelStateRepository', $repository);
