...
namespace WorkflowEngine\Tests\Model;
...
class ModelStateRepositoryTest extends TestCase
{
    ...
    public function testFindLatestModelState()
    {
        ...
        $repository = $this->em->getRepository('WorkflowEngine\Entity\ModelState');

        $this->assertInstanceOf('WorkflowEngine\Model\ModelStateRepository', $repository);
