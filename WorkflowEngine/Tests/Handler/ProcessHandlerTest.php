...
namespace WorkflowEngine\Tests\Handler;

use Symfony\Component\EventDispatcher\EventDispatcher;

use WorkflowEngine\Flow\NextStateInterface;
...
use WorkflowEngine\Tests\Fixtures\FakeProcessListener;
Use WorkflowEngine\Tests\Fixtures\FakeModel;
use WorkflowEngine\Tests\Fixtures\FakeSecurityContext;
use WorkflowEngine\Tests\Fixtures\FakeValidatorListener;
...
class ProcessHandlerTest extends TestCase
{
    ...
    /**
     * @var WorkflowEngine\Model\ModelStorage
     */
    ...
    protected function setUp()
    {
        ...
        $this->modelStorage = new ModelStorage($this->em, 'WorkflowEngine\Entity\ModelState');
    }
    ...
    /**
     * @expectedException        WorkflowEngine\Exception\WorkflowException
    ...
    public function testReachNextStateWithListener()
    {
        ...
        $reflectionClass = new \ReflectionClass('WorkflowEngine\Handler\ProcessHandler');
    ...
    protected function getProcessHandler()
    {
        $stepValidateDoc = new Step(
            ...
            'Validate doc',
            array(),
            array('setStatus', 'WorkflowEngine\Tests\Fixtures\FakeModel::STATUS_VALIDATE')
        );
        ...
        $stepRemoveDoc = new Step(
            ...
            'Remove doc',
            array(),
            array('setStatus', 'WorkflowEngine\Tests\Fixtures\FakeModel::STATUS_REMOVE')
        );
        ...
        $stepCreateDoc = new Step(
            ...
            'Create doc',
            array(),
            array('setStatus', 'WorkflowEngine\Tests\Fixtures\FakeModel::STATUS_CREATE')
        );
